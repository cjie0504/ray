            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="layout/index.jsp"><img src="/resources/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-10">
                    <div class="header__nav__option">
                        <nav class="header__nav__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="company/services.jsp">Services</a></li>
                                <li><a href="#">Pages</a>
                                    <ul class="dropdown">
                                        <li><a href="about.jsp">About</a></li>
                                        <li><a href="portfolio.jsp">Portfolio</a></li>
                                        <li><a href="company/blog.jsp">Blog</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="/resources/img/blog/prev.jpg" alt="">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item blog__details__option__item--right">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="/resources/img/blog/next.jpg" alt="">
                                        </div>
                                        <div class="blog__details__option__item__text">
                                            <h6>Looking for Music & Sounds for my new Android...</h6>
                                            <span>Nov 27, 2019</span>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="/resources/img/blog/ri-1.jpg" alt="">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="/resources/img/blog/ri-2.jpg" alt="">
                                        <h5>What are the steps of a body lift procedure?</h5>
                                        <span>Dec 06, 2019</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="/resources/img/blog/ri-3.jpg" alt="">
