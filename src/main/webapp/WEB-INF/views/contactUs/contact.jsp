    ...
    <div class="container">
        <div class="row">
            <div class="menuSubTitle col-lg-12">
                <div>
                    <h2 style="color: white;">Conatact Us</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="contact__widget__item">
                        ...
                        <div class="contact__widget__item__text">
                            <h4>ADDRESS</h4>
                            <p>222, Wangsimni-ro, Seongdong-gu, Seoul, Republic of Korea, International building 502-1 or 501 ho</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact__widget__item">
                        ...
                        <div class="contact__widget__item__text">
                            <h4>EMAIL</h4>
                            <p>kimyh900411@gmail.com</p>
                            <p>ykkim4@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
...
<%--                        <iframe--%>
<%--                                https://www.google.com/maps/place/Hanyang+International+Summer+School+(HISS)/data=!3m1!4b1!4m6!3m5!1s0x357ca4a4f95efca9:0x8cb8a0880c57350f!8m2!3d37.5581733!4d127.0482492!16s%2Fg%2F1ptx5f1z6--%>
